...
class TestCLIParser:
    ...
    def test_removed_subcommands_rejected(self):
        # Licensing/enterprise/industrial subcommands were dropped in the OSS
        # edition; the parser must reject them rather than silently accept.
        parser = _build_parser()
        for cmd in ["activate", "enterprise", "industrial"]:
