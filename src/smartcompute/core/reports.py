#!/usr/bin/env python3
"""
SmartCompute - HTML Report Generator
===============================================

Genera reportes HTML gráficos e interactivos además de los reportes .md
para análisis de SmartCompute en tiempo real.
"""
...
class SmartComputeHTMLReportGenerator:
    """Generador de reportes HTML para SmartCompute"""

    def __init__(self):
        self.output_dir = Path.home() / "smartcompute" / "reports"
        self.output_dir.mkdir(parents=True, exist_ok=True)

    def generate_analysis_html(self, json_report_path: str, auto_open: bool = True) -> str:
        ...
        html_content = self._create_analysis_html(data)
    ...
    def _create_analysis_html(self, data: Dict[str, Any]) -> str:
...
<head>
    ...
    <title>SmartCompute - Análisis en Tiempo Real</title>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="glass-card p-4 text-center metric-card">
                    ...
                    <h5 class="text-white">Módulos</h5>
            ...
            <div class="col-12">
                <div class="glass-card p-3 text-center">
                    <p class="text-white mb-0">
                        ...
                        Generado por SmartCompute Analysis Engine
                        <span class="ms-3">
...
<body>
        ...
        <div class="report-container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        <div class="metric-badge score-good">
                            <i class="fas fa-cogs me-1"></i> SmartCompute
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="metric-badge score-excellent">
            ...
            <div class="text-center p-3 bg-light border-top">
                <small class="text-muted">
                    ...
                    Generado automáticamente por SmartCompute Security Analysis Engine
                </small>
            </div>
        </div>
    </div>
    ...
    try:
        ...
        if json_reports:
            ...
            html_path = html_generator.generate_analysis_html(str(latest_report))
...
def main():
    ...
    if json_reports:
        ...
        html_path = generator.generate_analysis_html(str(latest_report))
