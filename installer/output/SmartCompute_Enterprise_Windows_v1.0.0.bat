...
:: SmartCompute Enterprise - Windows Installer
:: ==========================================
:: Instalador completo con Python embebido, validación de licencia y cifrado

title SmartCompute Enterprise - Installer v1.0.0
color 0B
...
echo [INFO] Validando licencia con servidor...
call :ValidateLicense "%LICENSE_USER%" "%LICENSE_PASS%"
if %errorLevel% neq 0 (
...
echo. >> "%install_dir%\uninstall.bat"
echo echo. >> "%install_dir%\uninstall.bat"
echo echo SmartCompute Enterprise ha sido desinstalado correctamente. >> "%install_dir%\uninstall.bat"
echo echo. >> "%install_dir%\uninstall.bat"
echo pause >> "%install_dir%\uninstall.bat"
